  ...
  return (
    <section className="mission-section" aria-labelledby="mission-title">
      <article className="mission-hero">
        <Image className="mission-aircraft" src="/mission-aircraft.webp" alt="" width={1920} height={421} unoptimized aria-hidden="true" />
      ...
      <div className="mission-notices">
        ...
        <article className="mission-notice mission-notice-warning"><h3>One warning:</h3><p>anything unrelated to flying machines — including personal files, entertainment videos, or pornographic content — may be removed, and the associated account may be blocked.</p></article>
      </div>
    </section>
  );
}
