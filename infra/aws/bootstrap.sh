...
put_secret_if_absent() {
  ...
  if aws ssm get-parameter \
    ...
    echo "Keeping existing secure parameter ${parameter_name}."
    return
  fi
...
put_secret_if_absent /fly-ae/v0-prod/session-secret
put_secret_if_absent /fly-ae/v0-prod/otp-pepper
put_secret_if_absent /fly-ae/v0-prod/share-encryption-secret
